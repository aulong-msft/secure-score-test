...
**Important to note:** CSE cannot certify/attest to security of an architecture nor code – the below is intended to help identify and track design decisions and outstanding work related to discussed attack vectors identified during the engagement and intended to provide guidance to CSE dev crews.

This document should remain internal-only and is intended to help produce backlog items specific to the customer engagement, in conjunction with those suggested via [BRIE (https://aka.ms/BRIE)](https://aka.ms/BRIE). Please direct your customer to work with their account team or preferred security vendor to seek an audit or pen-test from a security vendor if required/desired.

## Document History

| Version | Date | Author | Description |
| --- | --- | --- | --- |
| 0.1 | 11-22-2022 | Andrew Malkov | Initial draft |
...
[Privacy](https://www.cwcwiki.com/wiki/Security_Solution_Area#Privacy), in the context of information technology, it is a right of an individual to control the use and processing of their data in a digital ecosystem. This isn't the same as Security, though some of the activities intersect. Privacy deals with the governance of data while Security focuses on protecting its confidentiality, integrity, and availability.

The focus on Privacy in this document is aimed at collecting important information that will allow Dev Crews to mitigate risks in this area. Note that this is not a complete picture of the project’s posture but may provide some insights into a larger Privacy review i.e., should one be conducted.

### 2.1. Project Information on Privacy

Organization’s Role: Data Controller/Custodian  
Compliance Requirements for Privacy: U.S Privacy Act  
Data Residency Requirements: None

## 3. Diagrams

### 3.1. Original Diagram
...
#### 3.2.1. Data Flow Attributes

| # | Transport Protocol | Personal Data Elements | Data Classification | Authentication | Notes |
| :---: | :--- | :--- | :--- | :--- | :--- |
| 1  | HTTPS/TLS 1.2 | No | Confidential  | API Key | List of operations are sent to the device. No personal data is attached to the payload. |
| 2 | ... | ... | ...  | ... | ... |
...
- **Privacy**  
  Privacy relates to the activities that focus on individual users’ rights.

### 4.2. Microsoft Zero Trust Principles
...
### 4.3. Resources on Privacy

- A guide on how to differentiate Data Controllers from Data Providers: [Controllers and Processors Analysis Guide - FINAL.docx (sharepoint.com)](https://microsoft.sharepoint.com/:w:/s/privacy/EfwFn6tcHd5OuqV1Sz-J2bEB0tHhV-SMctiil37gWTdm9w?e=Tmz8VZ)
- In the absence of a Data Categorization standard from the customer, Microsoft’s standard can be used as a guide: [Identify Data Types (sharepoint.com)](https://microsoft.sharepoint.com/sites/privacy/SitePages/NGP%20Datatypes.aspx)
- [Data Residency in Azure | Microsoft Azure](https://azure.microsoft.com/en-us/global-infrastructure/data-residency/#overview)
- [Azure Products by Region | Microsoft Azure](https://azure.microsoft.com/en-us/global-infrastructure/services/?products=all&regions=us-central,us-east,us-east-2,us-north-central,us-south-central,us-west-central,us-west,us-west-2,us-west-3)
